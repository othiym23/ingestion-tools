# Found at http://www.nabble.com/remove-non-ASCII-characters-in-a-string-t973799.html
#
# Used because iconv() behaves inconsistently between libiconv and glibc 2.3.2 iconv,
# thus rendering it non-portable. Other options for proper transliteration seem to 
# be non-viable, for various reasons. Besides, I don't really care about "proper"
# transliteration, I just want a pure-ASCII reasonable approximation of the title
# to store on the filesystem.
#
# All examples called with Iconv.iconv("US-ASCII//TRANSLIT", "UTF-8", string)
#
# libiconv:                    Björk / Jøga / Füßé -> Bj"ork / Joga / F"uss'e
# glibc, LANG=en_US.UTF-8:     Björk / Jøga / Füßé -> Bj\000rk / J\000ga / F\000ss\000
# glibc, LANG=de_DE.UTF-8:     Björk / Jøga / Füßé -> Bjoerk / J\000ga / Fuesse
# me:                          ARRRRGH!
#
# thus:
#
# String::utf8_trans_unaccent: Björk / Jøga / Füßé -> Bjork / Joga / Fusse
...
class String
  def utf8_trans_unaccent
    ...
    tranmap.inject(self) { |str, (utf8, asc)| str.gsub(utf8, asc) }
  end
end
